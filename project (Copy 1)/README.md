...
- история входящих лайков и список взаимных симпатий с Telegram-контактами;
...
- админ-панель: обработка жалоб, скрытие анкеты, бан и рассылка;
- PostgreSQL для данных и Redis для состояний диалогов и антиспам-ограничения;
...
База данных создаётся автоматически при первом запуске. Для обновления уже работающего проекта без потери данных перед изменением моделей сначала сделайте резервную копию базы и добавьте миграции Alembic.
